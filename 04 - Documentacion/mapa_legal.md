...
* **Política de Privacidad del Widget:** Texto específico accesible desde el chat para informar al usuario final (alumnos, familias) sobre el tratamiento de sus consultas. *(Pendiente de publicar)*
...
| 🔴 **Urgente** | Política de Privacidad del Widget / Chatbot | Antes del despliegue en producción |
